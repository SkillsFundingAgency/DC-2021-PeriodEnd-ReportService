...
namespace ESFA.DC.PeriodEnd.ReportService.Reports.Interface.FundingSummary.Model
{
    public class FundingCategory
    {
        ...
        public FundingCategory(string fundingCategoryTitle, int currentPeriod, List<FundingSubCategory> fundingSubCategories, string contractAllocationNumber, string note = null)
        {
            FundingCategoryTitle = fundingCategoryTitle;
            CurrentPeriod = currentPeriod;
            FundingSubCategories = fundingSubCategories ?? new List<FundingSubCategory>();
            Note = note;
            ContractAllocationNumber = contractAllocationNumber;
        }

        public List<FundingSubCategory> FundingSubCategories { get; set; }

        public string FundingCategoryTitle { get; set; }
