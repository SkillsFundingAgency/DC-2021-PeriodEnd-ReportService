...
namespace ESFA.DC.PeriodEnd.ReportService.Reports.AppsCoInvestment
{
    ...
    {
        public IEnumerable<AppsCoInvestmentContribution> Map(
            IReportServiceContext reportServiceContext,
            IEnumerable<AppsCoInvestmentRecord> appsCoInvestmentRecords,
            CancellationToken cancellationToken)
        {
            var persistModels = new List<AppsCoInvestmentContribution>();

            foreach (var record in appsCoInvestmentRecords)
            {
                var persistModel = new AppsCoInvestmentContribution()
                {
