...
using ReportTaskNameConstants = ESFA.DC.PeriodEnd.ReportService.Legacy.Constants.ReportTaskNameConstants;

namespace ESFA.DC.PeriodEnd.ReportService.Legacy.Reports
{
