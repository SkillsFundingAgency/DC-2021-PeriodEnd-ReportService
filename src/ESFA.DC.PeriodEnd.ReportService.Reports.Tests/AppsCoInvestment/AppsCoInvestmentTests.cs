...
namespace ESFA.DC.PeriodEnd.ReportService.Reports.Tests.AppsCoInvestment
{
    public class AppsCoInvestmentTests
    {
        ...
        public async Task GenerateReport()
        {
            ...
            fileNameServiceMock.Setup(s => s.GetFilename(reportServiceContext.Object, "Apps Co-Investment Contributions Report", OutputTypes.Csv, true, true)).Returns(fileName);
            ...
            modelBuilderMock.Setup(b => b.Build(learners, payments, aecPriceEpisodePeriodisedValues, It.IsAny<int>(), It.IsAny<int>())).Returns(rows);
